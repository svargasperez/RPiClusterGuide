...
1. Finish with the actual installation: `sudo make install`
  -->
3. Install **MPI4PY**, which will make **Python** available to communicate with the cluster. First install the needed dependencies: `sudo apt install python3-pip python3-dev libopenmpi-dev -y`
